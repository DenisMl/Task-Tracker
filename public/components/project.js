...
let Project = React.createClass({
	...
	renderTask: function (task, i) {
		return (<Task key={i} user={this.props.user} task={task} devsList={this.state.projectDevelopers}
									closeAllDescriptions={this.props.closeAllDescriptions} parentProject={this.props.project}
									getProjectsInfo={this.props.getProjectsInfo}/>);
	},
